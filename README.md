...
#### Güvenlik
1.	API, JWT ile yetkilendirme sağlar. Admin ve User rolleri, JWT içinde taşınan payload ile belirlenir.
 
2.	Normal kullanıcılar sadece kendi faturalarını ve mesajlarını görüntüleyebilir ve ödeyebilir.
 
3.	Admin kullanıcıları ise tüm kullanıcıları yönetebilir ve fatura bilgilerini ekleyebilir/düzenleyebilir.

4.	Yetkilendirme için Authorize attribute'ları kullanılır ve her endpoint'e uygun roller atanır.
   
#### Veritabanı
1.	Veritabanı, Apartment, User, Bill ve Message tablolarını içerir.
